...
public class LinearTransfer extends CFAbstractTransfer<CFValue, CFStore, LinearTransfer> {
    ...
    public TransferResult<CFValue, CFStore> visitAssignment(
        ...
        //            oldLhsValue = in.getRegularStore().getValue((LocalVariableNode)
        // n.getTarget());
        //        }
        ...
        //        CFValue newRhsValue = analysis.createAbstractValue(newRhsSet,
        // rhsValue.getUnderlyingType());
        //        // Check rhs type, if rhs is not array,field access or local variable, just return
        // super
        //        // result
        ...
        //                        if (AnnotationUtils.areSameByName(atypeFactory.SHARED,
        // lhsAnnoMirror)) {
        //                            lhsStatesList =
        //                                    AnnotationUtils.getElementValueArray(
        ...
        //                    Set<AnnotationMirror> newLhsSet =
        // AnnotationUtils.createAnnotationSet();
